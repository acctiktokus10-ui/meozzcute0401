...
export default function Home() {
    ...
    <>
      ...
      <style>{`
        *{box-sizing:border-box;margin:0;padding:0}
        ...
        .login-wrap{min-height:100vh;display:flex;align-items:center;justify-content:center;padding:20px;background:linear-gradient(135deg,#e0f2fe,#f0f4f8)}
        .login-card{background:#fff;border-radius:24px;padding:48px 36px;width:100%;max-width:380px;text-align:center;box-shadow:0 8px 32px rgba(0,0,0,0.08)}
        .logo{font-size:48px;margin-bottom:12px}
        h1{color:#1e293b;font-size:24px;font-weight:700;margin-bottom:6px}
        .sub{color:#64748b;font-size:14px;margin-bottom:28px}
        input{width:100%;padding:14px 16px;background:#f8fafc;border:1.5px solid #e2e8f0;border-radius:12px;color:#1e293b;font-size:15px;margin-bottom:14px;outline:none}
        input:focus{border-color:#0ea5e9}
        button{width:100%;padding:14px;background:linear-gradient(135deg,#0ea5e9,#0284c7);border:none;border-radius:12px;color:#fff;font-size:15px;font-weight:700;cursor:pointer}
  ...
  return (
    <>
      ...
      <style>{`
        *{box-sizing:border-box;margin:0;padding:0}
        body{background:#f0f4f8;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;min-height:100vh;color:#1e293b}
        .wrap{min-height:100vh;padding-bottom:48px}

        header{background:#fff;border-bottom:1px solid #e2e8f0;padding:0 20px;position:sticky;top:0;z-index:10;box-shadow:0 1px 4px rgba(0,0,0,0.06)}
        ...
        .logout-btn{background:#f1f5f9;border:1px solid #e2e8f0;border-radius:8px;padding:7px 14px;color:#64748b;font-size:13px;cursor:pointer}
        ...
        /* Cards */
        .card{background:#fff;border-radius:20px;padding:22px;box-shadow:0 1px 4px rgba(0,0,0,0.06);border:1px solid #e2e8f0}
        .card-title{display:flex;align-items:flex-start;gap:12px;margin-bottom:18px}
        .card-icon{font-size:26px;flex-shrink:0}
        .card-title h2{font-size:15px;font-weight:700;color:#1e293b;margin-bottom:3px}
        .card-title p{font-size:13px;color:#64748b;line-height:1.5}

        /* CSV card accent */
        .csv-card{border-top:3px solid #0ea5e9}
        .reload-card{border-top:3px solid #10b981}

        /* File row */
        .file-row{display:flex;align-items:center;gap:12px;margin-bottom:14px;flex-wrap:wrap}
        .btn-choose{background:#f0f9ff;border:1.5px dashed #7dd3fc;border-radius:10px;padding:10px 18px;color:#0284c7;font-size:14px;font-weight:500;cursor:pointer;transition:all .2s;white-space:nowrap}
        .btn-choose:hover{background:#e0f2fe;border-color:#0ea5e9}
        ...
        .preview-box{flex:1;min-width:120px;background:#f0f9ff;border:1px solid #bae6fd;border-radius:12px;padding:12px 16px;display:flex;flex-direction:column;gap:4px}
        .preview-box span{font-size:12px;color:#64748b}
        .preview-box strong{font-size:20px;font-weight:700;color:#0284c7}

        /* Buttons */
        .btn-row{display:flex;gap:10px;flex-wrap:wrap}
        .btn-process{flex:1;min-width:130px;padding:12px;background:#f0f9ff;border:1.5px solid #7dd3fc;border-radius:12px;color:#0284c7;font-size:14px;font-weight:600;cursor:pointer;transition:all .2s}
        .btn-process:not(:disabled):hover{background:#e0f2fe}
        .btn-process:disabled{opacity:.4;cursor:not-allowed}
        .btn-update{flex:1;min-width:130px;padding:12px;background:linear-gradient(135deg,#0ea5e9,#0284c7);border:none;border-radius:12px;color:#fff;font-size:14px;font-weight:700;cursor:pointer;transition:opacity .2s;box-shadow:0 2px 8px rgba(14,165,233,.3)}
        .btn-update:not(:disabled):hover{opacity:.88}
        .btn-update:disabled{opacity:.35;cursor:not-allowed}
        .btn-reload{width:100%;padding:13px;background:linear-gradient(135deg,#10b981,#059669);border:none;border-radius:12px;color:#fff;font-size:15px;font-weight:700;cursor:pointer;transition:opacity .2s;box-shadow:0 2px 8px rgba(16,185,129,.25)}
        ...
        /* Guide */
        .guide{background:#fff;border-radius:20px;padding:22px;box-shadow:0 1px 4px rgba(0,0,0,0.06);border:1px solid #e2e8f0}
        .guide h3{font-size:14px;font-weight:600;color:#64748b;margin-bottom:16px}
        .steps{display:flex;flex-direction:column;gap:12px}
        .step{display:flex;align-items:flex-start;gap:12px;font-size:14px;color:#475569;line-height:1.5}
        .num{background:#e0f2fe;color:#0284c7;border-radius:50%;width:22px;height:22px;display:flex;align-items:center;justify-content:center;font-size:12px;font-weight:700;flex-shrink:0;margin-top:1px}
        code{background:#f1f5f9;padding:2px 6px;border-radius:5px;font-size:12px;font-family:monospace;color:#0284c7}
        b{color:#1e293b}
      `}</style>
    </>
  )
